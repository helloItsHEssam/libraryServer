...
fileprivate let tolkienImage = Image(id: 101, url: "http://localhost:8080/image/101.jpg")
...
fileprivate let ishiguroImage = Image(id: 102, url: "http://localhost:8080/image/102.jpeg")
...
fileprivate let haigImage = Image(id: 103, url: "http://localhost:8080/image/103.jpg")
...
fileprivate let hobbitImage = Image(id: 1, url: "http://localhost:8080/image/1.jpg")
...
fileprivate let fellowShipImage = Image(id: 2, url: "http://localhost:8080/image/2.jpg")
...
fileprivate let twoTowerImage = Image(id: 4, url: "http://localhost:8080/image/4.jpg")
...
fileprivate let returnTheKingImage = Image(id: 3, url: "http://localhost:8080/image/3.jpg")
...
fileprivate let kelaraImage = Image(id: 8, url: "http://localhost:8080/image/8.jpg")
...
fileprivate let neverLetMeGoImage = Image(id: 7, url: "http://localhost:8080/image/7.jpg")
...
fileprivate let remainOfDayImage = Image(id: 6, url: "http://localhost:8080/image/6.jpg")
...
fileprivate let WhenWeImage = Image(id: 5, url: "http://localhost:8080/image/5.jpg")
...
fileprivate let midnightLibraryImage = Image(id: 9, url: "http://localhost:8080/image/9.jpg")
